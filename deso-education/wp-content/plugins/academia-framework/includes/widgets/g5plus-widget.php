...
abstract class G5Plus_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		add_action( 'save_post', array( $this, 'flush_widget_cached' ) );
		add_action( 'deleted_post', array( $this, 'flush_widget_cached' ) );
		add_action( 'switch_theme', array( $this, 'flush_widget_cached' ) );
	...
	function get_cached_widget( $args ) {
		...
		if (array_key_exists('widget_id',$args) && isset( $cache[ $args['widget_id'] ] ) ) {
	 ...
	 * @return void
	 */
	public function flush_widget_cached() {
				...
				case "icon":
					...
					<div style="margin: 13px 0">
						...
						<div>
							...
							<input style="float: right"  title="<?php echo esc_html__('Click to browse icon','g5plus-academia') ?>" class="browse-icon button-secondary" type="button" value="<?php echo esc_html__('Browse...','g5plus-academia') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo esc_html__('Click to browse image','g5plus-academia') ?>" class="browse-images button-secondary" type="button"><?php echo esc_html__('Browse...','g5plus-academia') ?></button>
						</div>
