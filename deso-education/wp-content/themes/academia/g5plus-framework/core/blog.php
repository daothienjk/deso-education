...
if ( ! function_exists( 'g5plus_paging_nav' ) ) {
	function g5plus_paging_nav() {
		...
		if (count($query_args) > 0) {
			$page_links['add_args'] = array_map( 'urlencode', $query_args );
        }
    ...
    function g5plus_post_thumbnail($size = '',&$showDate=false) {
        ...
        switch(get_post_format()) {
            ...
            case 'gallery':
                ...
                if (count($images) > 0) {
                    $data_plugin_options = "data-plugin-options='{\"items\" : 1, \"dots\" : false, \"nav\" : true, \"animateOut\" : \"fadeOut\", \"animateIn\" : \"fadeIn\", \"autoplay\" : true, \"loop\" : false}'";
