...
function g_register_required_plugins()
{
    ...
    $plugins = array(
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/includes/plugins/academia-framework-v1.2.zip', // The plugin source
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/includes/plugins/revslider_5.4.8.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/includes/plugins/js_composer_5.5.2.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/includes/plugins/envato-market-v2.0.0.zip', // The plugin source
