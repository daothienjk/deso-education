...
if ( ! class_exists( 'Redux_Framework_options_config' ) ) {
    ...
    class Redux_Framework_options_config {
        ...
        public function setSections() {
            ...
            // Google Map
	        $this->sections[] = array(
		        'title'  => esc_html__( 'Google Map', 'g5plus-academia' ),
		        'desc'   => '',
		        'subsection' => true,
		        'icon'   => 'el el-map-marker',
		        'fields' => array(
			        array(
				        'id' => 'enable_googlemap_ssl',
				        'type' => 'button_set',
				        'title' => esc_html__('Google Maps SSL', 'g5plus-academia'),
				        'subtitle' => esc_html__('Use google maps with ssl', 'g5plus-academia'),
				        'desc' => '',
				        'options' => array('1' => 'On','0' => 'Off'),
				        'default' => '0'
			        ),
			        array(
				        ...
				        'type'      => 'text',
				        'title'     => esc_html__('Google Maps API KEY', 'g5plus-academia'),
				        'subtitle' => esc_html__('Enter your google maps api key','g5plus-academia'),
				        'desc' => sprintf(wp_kses_post(__('We strongly encourage you to get an APIs Console key and post the code in Theme Options. You can get it from <a target="_blank" href="%s">here</a>.','g5plus-academia')),'https://developers.google.com/maps/documentation/javascript/tutorial#api_key'),
				        'default'   => '',
			        ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'product_order_by',
                        'type' => 'select',
                        'title' => esc_html__('Course Order By', 'g5plus-academia'),
                        'options' => array(
                            'ID'		=> 'Course ID',
                            'start'		=> 'Start date',
                            'title'		=> 'Course Name'
                    ...
                    array(
                        'id' => 'product_order',
                        'type' => 'select',
                        'title' => esc_html__('Course Order', 'g5plus-academia'),
                        'options' => array(
                            'ASC'		=> 'Accending',
                            'DESC'		=> 'Descending'
                        ),
	                ...
	                array(
		                ...
		                'type' => 'image_select',
		                'title' => esc_html__('Sidebar', 'g5plus-academia'),
		                'subtitle' => esc_html__('Set Archive Course Sidebar', 'g5plus-academia'),
		                'desc' => '',
		                'options' => array(
			                'none' => array('title' => '', 'img' => G5PLUS_THEME_URL.'assets/images/theme-options/sidebar-none.png'),
			                'left' => array('title' => '', 'img' => G5PLUS_THEME_URL.'assets/images/theme-options/sidebar-left.png'),
	                ...
	                array(
		                ...
		                'default' => 'large',
		                'required'  => array('archive_product_sidebar', '=', array('left','right')),
	                ),
	                array(
		                'id' => 'archive_product_left_sidebar',
		                'type' => 'select',
		                'title' => esc_html__('Left Sidebar', 'g5plus-academia'),
		                'subtitle' => esc_html__('Choose the default archive Course left sidebar','g5plus-academia'),
		                'data'      => 'sidebars',
		                'desc' => '',
		                'default' => 'woocommerce',
		                'required'  => array('archive_product_sidebar', '=', array('left')),
	                ),
	                array(
		                'id' => 'archive_product_right_sidebar',
		                'type' => 'select',
		                'title' => esc_html__('Right Sidebar', 'g5plus-academia'),
		                'subtitle' => esc_html__('Choose the default Archive Course right sidebar','g5plus-academia'),
		                'data'      => 'sidebars',
		                'desc' => '',
		                'default' => 'woocommerce',
		                'required'  => array('archive_product_sidebar', '=', array('right')),
	                ),
